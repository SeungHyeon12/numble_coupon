...
export declare class CouponServiceDtoMapper {
    toRegisterCommand(request: RegisterCouponRequest): RegisterCouponCommand;
    toUpdateCommand(request: UpdateCouponRequest, couponUuid: string): UpdateCouponCommand;
    toUseCommand(request: UseCouponRequest, couponUuid: string): UseCouponCommand;
    toCancleCommand(request: CancleCouponRequest, couponUuid: string): CancleCouponCommand;
    toGetCouponsCommand(request: GetCouponsRequest, page: number, size: number): GetCouponsCommand;
    toQueueIssuranceCommand(request: IssueCouponRequest, couponUuid: string): QueueIssuranceCommand;
}
